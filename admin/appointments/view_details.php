        ...
        <div class="card-body">
            <div class="container-fluid">
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tr>
                                        <th class="text-muted text-white bg-gradient-dark px-2 py-1">Appointment Request
                                            Code</th>
                                        <td>
                                            <?=($code) ?>
                                        </td>
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sched = $conn->query("SELECT * FROM `scheduler` where id ={$sched_id} ");
                                foreach($sched as $row){
                                  echo '
                                    <h6>Date : <br/> <span class="text-primary">'.date('F j,Y',strtotime($row['schedule'])).' </span></h6>
                                 <h6> Time</h6> <h6 class="text-danger">'.date('h:i a',strtotime($row['timestart'])).'  -  '.date('h:i a',strtotime($row['timeend'])).'  </h6>';
                                }
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <table class="table table-stripped table-bordered" data-placeholder='true'>
                                        ...
                                        <tbody>
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Pet Services</th>
                                                <td class="py-1 px-2 text-right">
                                                    <?=($pet_type) ?>
                                                </td>
                                            </tr>
                                            <tr class="border-info">
                                                <th class="py-1 px-2 text-light bg-gradient-info">Pet Name</th>
                                                <td class="py-1 px-2 text-right">
                                                    <?=($breed) ?>
                                                </td>
                                            </tr>
                ...
                <div class="rounded-0 text-center mt-3">
                    <a class="btn btn-sm btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i
                            class="fa fa-edit"></i> Update Status</a>
                    <button class="btn btn-sm btn-danger btn-flat" type="button" id="delete_data"><i
                            class="fa fa-trash"></i> Delete</button>
                    <a class="btn btn-light border btn-flat btn-sm" href="./?page=appointments"><i

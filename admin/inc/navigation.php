        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul
              ...
              <!--
                    <li class="nav-item">
    remove space "<"                  <a href="< ?php echo base_url ?>admin/?page=appointments" class="nav-link nav-appointments">
                    ...
                    <li class="nav-item">
      remove space "<"                      <a href="< ?php echo base_url ?>admin/?page=inquiries" class="nav-link nav-inquiries">
...
-->
              <?php if ($_settings->userdata('type') == 1): ?>
                ...
                <!--
                                          <li class="nav-item dropdown">
                               remove space "<"              <a href="< ?php echo base_url ?>admin/?page=user/list" class="nav-link nav-user_list">

			...
			<form action="" id="system-frm">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="number" class="form-control form-control-sm col-sm-3" name="max_appointment"
							id="max_appointment" value="<?php echo $_settings->info('max_appointment') ?>">
					</div>
					<div class="form-group">
						<label for="clinic_schedule" class="control-label">Clinic Daily Schedule <small><em>i.e.(8:00 AM
									- 5:30 PM)</em></small></label>
						<input type="text" class="form-control form-control-sm col-sm-3" name="clinic_schedule"
							id="clinic_schedule" value="<?php echo $_settings->info('clinic_schedule') ?>">
					</div>
				</fieldset>
			</form>
		</div>

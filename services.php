...
?>
<div class="content py-5" style="background-image: url('uploads/background.jpg');">
    <h3 style="text-align: center; color: B;">Image Detection <i class="fa fa-arrow-right"></i></h3>

    <hr>
    <iframe src="https://editor.p5js.org/paa23kelvin/full/BNGWXu-N4" allow="camera"
        style="position: relative; top: -380px" frameborder="0" scrolling="no" width="35%" height="520" align="right">
    </iframe>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4" style="background-image: url('uploads/b1.jpg');">
                    ...
                    while ($row = $cat_qry->fetch_assoc()):
                        ...
                        <div class="list-group-item list-group-item-action">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="category_<?= $row['id'] ?>" class="custom-control-label">
                                    <?= $row['name'] ?>
                                </label>
                            </div>
                        </div>

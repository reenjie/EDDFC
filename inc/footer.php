...
<footer class="main-footer text-sm">
  <div class="container">
    ...
    <div class="float-right d-none d-sm-inline-block" style="position: absolute;">
      <b>
        <?php echo $_settings->info('short_name') ?> (by: <a href="mailto:paakelvin23@gmail.com"
          target="">paa23kelvin</a> )
      </b>
    </div>
  </div>
</footer>
